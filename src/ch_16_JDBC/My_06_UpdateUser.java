...
class DBUpdate extends DBSelect {
	protected User modifyUser() {
		...
		String validateTemp;
		do {
			System.out.println("정보 수정 및 회원의 아이디를 입력하세요");
			user.userID = scanner.nextLine();
			System.out.println("회원의 이름을 입력하세요: ");
			user.name = scanner.nextLine();
			System.out.println("회원의 나이을 입력하세요: ");
...
//		System.out.println(updateSQL);
		...
		preparedStatement = conn.prepareStatement(updateSQL);	// 쿼리 실행준비
		...
		// pstmt.excuteUpdate() : update, delete, insert
