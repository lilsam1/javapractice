...
public class Calendar_ex02 {
	...
	public static void main(String[] args) {
		...
		int month = calendar.get(Calendar.MONTH) + 1;	// 실제 월 보다 1작은 값이 반환되서 1을 더해 보정 
		...
		// 1 = 일요일, 2= 월요일, 7= 토요일
		System.out.println("오늘은 " + getDayToStr(Calendar.DAY_OF_WEEK) + "요일입니다");
		System.out.print("이번 년도에서 오늘이 몇 일째인가? : ");
		System.out.println(calendar.get(Calendar.DAY_OF_WEEK));	// 이번 년도의 며칠인지
