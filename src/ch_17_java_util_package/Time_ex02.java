...
public class Time_ex02 {
	...
	*/
	...
	public static void main(String[] args) {
		...
		/* LocalDate 클래스
		 날짜 정보를 저장. 날짜 정보를 저장하는 방법은 
		 1) 현재 날짜 지정하는 now() 메서드를 쓰는 방법과
		 2) 특정 날짜를 지정하는 of() 메서드를 사용하는 방법이 있음
		*/
		
		// 날짜를 더하고 빼는 메서드를 확인하는 코드
		// minusYears(long) 년도 뺴기, minusMonts(long) 월 뺴기, minusDays(long) 일 빼기, minusWeeks(long) 주 빼기
		// plusYears(long) 년도 더하기, plusMonts(long) 월 더하기, plusDays(long) 일 더하기, plusWeeks(long) 주 더하기
		
		LocalDate ld = LocalDate.now(); // 현재 날짜를 지정
		System.out.println(ld);	// 2022-12-16
		
		// 2년을 뺴고 3달을 더하고 4일을 뺌
