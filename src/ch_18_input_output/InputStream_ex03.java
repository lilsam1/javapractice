...
public class InputStream_ex03 {
	...
	public static void main(String[] args) {
		...
		/* FileInputStream
		 : 파일에서 바이트 단위로 자료를 읽어 들일 때 사용하는 스트링 클래스
		...
		try {
			fis = new FileInputStream("./sample_file/input.txt");	// imput.txt 파일 스트릠 생성
			
			// read() 메서드의 반환형은 int. 한 바이트를 읽어 int에 저장. 더 이상 읽어 드릴 자료가 없는 경우 -1반환
