...
/* Class 클래스를 활용해 클래스 정보 알아보기
 프로그램을 하다 보면 사용할 클래스의 자료형을 모르는 경우에 사용
 ...
 Class 클래스와 java.langa.reflect 패키지의 클래스를 사용하면 리플렉션 프로그래밍이 가능
 */
...
//		Class strClass = Class.forName("java.lang.String");	// 클래스 이름으로 가져오기
		Class strClass = Class.forName("ch_13_java.lang.Person");	// 클래스 이름으로 가져오기
