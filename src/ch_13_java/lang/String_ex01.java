...
public class String_ex01 {
	/* String 클래스
	 ...
	 2) 문자열 상수를 가르키는 방식
	  String str3 = "abc";
	  생성자를 이용하지 않고 바로 문자열 상수를 가리키는 경우에는 기존에 만들어져 있떤 문자열 상수의 메모리 값을 가르키게 됨
	  프로그램에서 사용되는 상수 값을 저항하는 공간을 상수 풀 constant pool 이라고 함
	 */
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String str1 = new String("abc");	// 생서자의 매개변수로 문자열 생성
		String str2 = new String("abc");
		
		System.out.println(str1 == str2);	// false. 인스턴스가 매번 새로 생성되므로 str1과 ㄴtr2는 주소 값이 다름
